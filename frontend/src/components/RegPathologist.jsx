...
function Regpathologist() {
    ...
    useEffect(() => {
        ...
        if (Object.keys(errors).length === 0 && submitted) {
            ...
            axios.post("http://localhost:5000/api/emp", formData)
                .then(resp => {
                    console.log(resp)
                    alert("Pathologist registered successfully")
                    history.push("/slogin")
                })
                    ...
                    <div className="row">
                        <div className="col-sm-9 mx-auto">
                            <h4 className="text-center p-2">
                                Pathologist Registration Form
                            </h4>
                            <form onSubmit={handleSubmit}>
                                <div className="form-group form-row">
                                    <label className="col-sm-4 form-control-label">Pathologist Name</label>
